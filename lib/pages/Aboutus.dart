      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 32),
            Text(
              'Our app is still under development, and we are constantly adding new features and improving the user experience. We appreciate any feedback you have, so please feel free to contact us at [mandal123rohit@gmail.com]',
              style: TextStyle(
                  fontSize: 16, fontFamily: 'kanit', color: Colors.grey[700]),
            ),
            SizedBox(height: 32),
